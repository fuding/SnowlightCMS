<?php /* Smarty version Smarty-3.0.8, created on 2011-08-15 22:01:53
         compiled from "C:/xampp/htdocs/_templates/_pages/_me.tpl" */ ?>
...
<?php $sha = sha1("_files/_header_default.tpl" . $_smarty_tpl->cache_id . $_smarty_tpl->compile_id);
...
$_template = new Smarty_Internal_Template("_files/_header_default.tpl", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null);
}
...
<div id="container"> 
	...
	<div id="habbo-plate"> 
		    <a href="http://www.habbo.com/identity/avatars"> 
				<img alt="<?php echo $_smarty_tpl->getVariable('USER')->value['NAME'];?>
" src="http://habbo.de/habbo-imaging/avatarimage?figure=<?php echo $_smarty_tpl->getVariable('USER')->value['FIGURE'];?>
" /> 
		</a> 
	</div> 
	...
	<div id="habbo-info"> 
		<div id="motto-container" class="clearfix">			
			<strong><?php echo $_smarty_tpl->getVariable('USER')->value['NAME'];?>
:</strong> 
			<div> 
				<span title="What's on your mind today?"><?php echo $_smarty_tpl->getVariable('USER')->value['MOTTO'];?>
</span> 
	...
	<ul id="link-bar" class="clearfix">		
		<li class="credits"> 
			<a href="http://www.habbo.com/credits"><?php echo $_smarty_tpl->getVariable('USER')->value['CREDITS'];?>
</a> Credits
		</li> 
		 ...
		 <li class="club"> 
		    ...
		    <li class="activitypoints"> 
			    <a href="/credits/pixels"><?php echo $_smarty_tpl->getVariable('USER')->value['PIXELS'];?>
</a> Pixels
		    </li> 
	</ul> 
...
<script type="text/javascript"> 
	HabboView.add(function() {
		...
		PersonalInfo.init("<?php echo $_smarty_tpl->getVariable('USER')->value['MOTTO'];?>
");
	});
</script> 
    ...
    <ul id="hotcampaigns-habblet-list"> 
       <?php echo $_smarty_tpl->getVariable('HOT_CAMPAIGNS')->value;?>
...
<script type="text/javascript"> 
    ...
    L10N.put("date.pretty.minutes_ago", "<?php echo 0;?>
 minutes ago");            
    L10N.put("date.pretty.one_hour_ago", "1 hour ago");            
    L10N.put("date.pretty.hours_ago", "<?php echo 0;?>
 hours ago");            
    L10N.put("date.pretty.yesterday", "yesterday");            
    L10N.put("date.pretty.days_ago", "<?php echo 0;?>
 days ago");            
    L10N.put("date.pretty.one_week_ago", "1 week ago");            
    L10N.put("date.pretty.weeks_ago", "<?php echo 0;?>
 weeks ago");            
...
<div id="staffpicks-groups-habblet-list-container" class="habblet-list-container groups-list"> 
    <ul class="habblet-list two-cols"> 
        <?php echo $_smarty_tpl->getVariable('HOT_STUFF')->value;?>
...
<?php $sha = sha1("_files/_footer_default.tpl" . $_smarty_tpl->cache_id . $_smarty_tpl->compile_id);
if (isset($_smarty_tpl->smarty->template_objects[$sha])) {
$_template = $_smarty_tpl->smarty->template_objects[$sha]; $_template->caching = 9999; $_template->cache_lifetime =  null;
} else {
$_template = new Smarty_Internal_Template("_files/_footer_default.tpl", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null);
}
$_template->assign('title','foo'); echo $_template->getRenderedTemplate(); $_template->rendered_content = null;?><?php unset($_template);?>