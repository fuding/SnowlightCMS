...
/* Load Core */
require($_SERVER["DOCUMENT_ROOT"]."/_includes/_core/_core.php");

$core->check_login();

$name = $sql->real_escape_string($_POST['searchString']);

$result = $sql->query("SELECT * FROM characters WHERE username like '%".$name."%' ORDER BY username LIMIT 0,10");
$list = "";
$i = 0;
while ($row = $result->fetch_object()){
 $i++;
    ...
    $list .= "<li class=\"".$color." offline\" homeurl=\"/home/".$row->username."\" style=\"background-image: url(http://www.habbo.com/habbo-imaging/avatar/hr-165-36.hd-209-11.ch-255-64.lg-280-64.sh-906-72.he-1609-72.ca-1810,s-3.g-0.d-3.h-3.a-0,ccab0890613c21439d7275a56c8cac49.gif)\">
                        <div class=\"item\">
                            <b>".$row->username."</b><br />
                        ...
                        <div class=\"tools\">
                                <a href=\"#\" class=\"add\" avatarid=\"".$row->id."\" title=\"Add ".$row->username." to your friend list\"></a>
                        </div>
                        <div class=\"clear\"></div>
                    </li>";
