{include file="_files/_header_index.tpl" title=foo} 
<body id="frontpage">
<div id="overlay"></div>
...
<div id="frontpage-image-container">
    ...
    <div id="people-inside">
        ...
        <b><span><span class="stats-fig">{$HOTEL.ONLINECOUNT}</span> {$T_USERS_ONLINE}</span></b>
...
{include file="_files/_footer_index.tpl" title=foo}