...
<head>
  ...
  <title>{$HOTEL.SHORT_NAME} - Register</title>
...
<body>
  <div id="container">
    ...
    "0" name="logo" /></a> <span id="stats">{$HOTEL.ONLINECOUNT} {$T_USERS_ONLINE}</span>

    <div id="clear"></div>
    <hr />

    <div id="user_taken">
      {$T_NAME_NOT_AVAILABLE}
    </div>

    <div id="user_avaliable">
      {$T_NAME_AVAILABLE}
    </div>{$T_REGISTER_GREETING}<br />
    <br />

    <form action="" method="post">
      <table width="100%" border="0">
        <tr>
          <td width="25%">{$T_USERNAME}:</td>
